...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    clear_all:                                                                                      '清除全部',
    clear_by_name:                                                                                  '以名稱清除',
    clear_by_purpose_and_stacklevel:                                                                '以目的和排程優先層級清除',
    ...
    hmi_info:                                                                                       'HMI資訊',
    profile_name:                                                                                   '排程檔名稱',
    profile_purpose:                                                                                '排程檔目的',
    profile_stack_level:                                                                            '排程檔優先層級',
    rate:                                                                                           '費率',
    remote_start:                                                                                   '遠端開啟',
    remote_stop:                                                                                    '遠端停止',
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    invoice_hash_iv:                                                                                'InvoiceHashIV',
    invoice_hash_key:                                                                               'InvoiceHashKey',
    invoice_merchant_id:                                                                            'InvoiceMerchantID',
    payment_hash_iv:                                                                                'PaymentHashIV',
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    the_format_should_be_number_with_limit_to_12_characters:                                        '自訂編號，限為數字，最長為12碼',
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    password_length_should_be_at_least_8_characters_but_cannot_over_20_characters:                  '密碼長度至少要8個字元，但不可超過20個字元',
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    rfid_card_cannot_be_removed_because_the_amount_is_not_0:                                        'RFID卡無法移除，因為金額不為 0',
    rfid_card_cannot_be_removed_because_the_evse_is_occupied:                                       'RFID卡無法移除，因為充電樁被佔用',
    ...
    total_rfid:                                                                                     'RFID總數',
    user_cannot_be_deteted_because_the_rfid_card_has_not_been_deleted_yet:                          '使用者無法刪除，因為RFID卡尚未刪除',
