      ...
      <div class="left">
        <div class="left-up">
          ...
          <div class="left-up-main">
            ...
            <div class="left-up-right">
              ...
              <el-checkbox v-model="StationData.charging_when_closed" label="Charging when place is closed" size="large" />
            </div>
          </div>
        ...
        <div class="left-down">
          ...
          <div class="left-down-line1">
            <div>
              <p>Country</p>
              <el-select v-model="StationData.country" placeholder="Select" size="large" @change="change_country_code(StationData)">
...
const saveStation = async () => {
  ...
  let sendData = {  'class' : 'Location', 'id': station_id, 
