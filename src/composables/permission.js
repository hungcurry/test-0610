...
let m_cloud_permission =  {
    AdminUser : {
        ...
        EVSEDetail:{ page:'O', delete:'O', dataTransfer:'O', getChargingProfile:'O', changeConfiguration:'O', compositeSchedule:'O', chargingProfile:'O',  getDiagnostics:'O', changeAvailablility:'O', clearChargingProfile:'O'},
    ...
    ViewerUser : {
        ...
        EVSEDetail:{ page:'O', delete:'X', dataTransfer:'X', getChargingProfile:'O', changeConfiguration:'X', compositeSchedule:'O', chargingProfile:'O',  getDiagnostics:'O', changeAvailablility:'X', clearChargingProfile:'X'},
    ...
    CustomerServiceUser : {
        ...
        EVSEDetail:{ page:'O', delete:'X', dataTransfer:'X', getChargingProfile:'X', changeConfiguration:'X', compositeSchedule:'X', chargingProfile:'X',  getDiagnostics:'X', changeAvailablility:'X', clearChargingProfile:'X'},
        EVSEEdit:{ page:'O', save: 'X'},
        RatePlan: { page:'O', addRatePlan:'X', delete:'X', copy:'X'},
        RatePlanDetail: { page:'O', addRatePlan:'X', save:'X'},
        User: { page:'O', addUser:'X', userDetail:'O'},
    ...
    EngineerUser : {
        ...
        EVSEDetail:{ page:'X', delete:'X', dataTransfer:'X', getChargingProfile:'X', changeConfiguration:'X', compositeSchedule:'X', chargingProfile:'X',  getDiagnostics:'X', changeAvailablility:'X', clearChargingProfile:'X'},
