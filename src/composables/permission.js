...
let m_cloud_permission =  {
  AdminUser : {
    ...
    EVSEDetail:{ page:'O', delete:'O', edit:'O', chargingProfile:'O', configuration:'O', getDiagnostics:'O', changeAvailablility:'O', remoteTransaction: 'O'},
    ...
    UserDetail: { page:'O', clear:'O', userEdit:'O', cardDetails:'O', deviceDetail:'O', homeDeviceDetails:'O', sendNotification:'O', payment:'O' , homeSession:'O'},
  ...
  FAEUser : {
    ...
    StationEdit:{ page:'O', save:'O', delete:'O'},
    EVSE:{ page:'O', addEVSE:'O', reset:'O', update:'O'},
    EVSEDetail:{ page:'O', delete:'X', edit:'O', chargingProfile:'O', configuration:'O', getDiagnostics:'O', changeAvailablility:'O', remoteTransaction: 'O'},
    EVSEEdit:{ page:'O', save: 'O'},
    RatePlan: { page:'O', addRatePlan:'O', delete:'O', copy:'O', edit:'O'},
    RatePlanDetail: { page:'O', addRatePlan:'O', save:'O'},
    ...
    UserDetail: { page:'O', clear:'X', userEdit:'X', cardDetails:'X', deviceDetail:'X', homeDeviceDetails:'X', sendNotification:'X', payment:'X' , homeSession:'X'},
  ...
  ViewerUser : {
    ...
    EVSEDetail:{ page:'O', delete:'X', edit:'O', chargingProfile:'O', configuration:'O', getDiagnostics:'O', changeAvailablility:'O', remoteTransaction: 'X'},
    ...
    //-------- AdvancedSetting ----------
    User: { page:'O', addUser:'X', userDetail:'O'},
    UserDetail: { page:'O', clear:'X', userEdit:'X', cardDetails:'O', deviceDetail:'O', homeDeviceDetails:'O', sendNotification:'O', payment:'O' , homeSession:'O'},
  ...
  CustomerServiceUser : {
    ...
    //-------- AdvancedSetting ----------
    User: { page:'O', addUser:'X', userDetail:'O'},
    UserDetail: { page:'O', clear:'X', userEdit:'X', cardDetails:'O', deviceDetail:'O', homeDeviceDetails:'O', sendNotification:'X', payment:'O' , homeSession:'O'},
    Company: { page:'O', addCompany:'X', detail:'X'},
    Administrator: { page:'O', addAdmin:'X', detailAdmin:'X', downloadList:'X'},
    SoftwareInfo: { page:'O', addSwRelease:'X', addFwRelease:'X', release:'X', detail:'X'},
    Program: { page:'O', addProgram:'X', detail:'X',},
  ...
  EngineerUser : {
    ...
    EVSEDetail:{ page:'X', delete:'X', edit:'X', chargingProfile:'X', configuration:'X', getDiagnostics:'X', changeAvailablility:'X', remoteTransaction: 'X'},
